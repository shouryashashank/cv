...
\usepackage{xcolor}
\definecolor{darkteal}{rgb}{0.0, 0.4, 0.4}
% Some settings:
\raggedright
...
\titleformat{\section}{\needspace{4\baselineskip}\bfseries\large}{}{0pt}{}[\vspace{1pt}\color{darkteal}\titlerule]
...
\begin{document}
    ...
    \section{EDUCATION}
        ...
        \begin{twocolentry}{\textcolor{darkteal}{
            July 2016 – May 2021}
        }
    ...
    \section{EXPERIENCE}
        ...
        \begin{onecolentry}
            ...
            \textbf{\normalsize Advanced Software Development Engineer} \hfill \textit{\textcolor{darkteal}{July 2021 – Present}} \\ % Adds slight spacing
            ...
            \vspace{0.2 cm}
            \textbf{\normalsize Software Engineer Intern} \hfill \textit{\textcolor{darkteal}{June 2020 -  August 2020}} \\ % Adds slight spacing
            \begin{adjustwidth}{0.4cm}{0cm}
                \begin{highlights}
            ...
            \vspace{0.2 cm}
            \textbf{\large  Blueseed Ventures} \hfill \textit{\textcolor{darkteal}{December 2018}} \\  
            \begin{adjustwidth}{0.4cm}{0cm}
                \begin{highlights}
    ...
    \begin{onecolentry}{
        ...
        \textbf{PREDACONS | Founder and Maintainer} \hfill \textit{\textcolor{darkteal}{October 2023 - Present}}\end{onecolentry}
